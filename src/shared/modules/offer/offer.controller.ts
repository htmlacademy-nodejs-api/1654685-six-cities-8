...
import { OwnOfferMiddleware } from '../../libs/rest/index.js';
...
export class OfferController extends BaseController {
  ...
  public async addToFavorite(
    ...
    this.created(res, `Offer with id "${params.offerId}" was added to favorites`);
  }

  public async getPremiumOfferByCity({ params, tokenPayload }: Request<ParamCity>, res: Response) {
  ...
  public async removeFromFavorite(
    ...
    this.noContent(res, `Offer with id "${params.offerId}" was removed from favorites`);
  }
